<div class="table-header">
    <a href="./?page=subkriteria&proses=tambah" class="btn btn-xs btn-success"><i class="ace-icon glyphicon glyphicon-plus bigger-80"></i> Tambah</a>
</div>
<div>
                ...
                while ($data = $execute->fetch_array(MYSQLI_ASSOC)) { ?>
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a class="red" href="./subkriteria/delete.php?id=<?= $data['kode_subkriteria'] ?>" onclick="return confirm('Anda yakin hapus data ini?');">
